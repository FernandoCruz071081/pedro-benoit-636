...
const PLANCHAS_INIT = [
  ...
  { id:3, autorKey:"cheffler", titulo:"El Sendero del Compañero", grado:"Compañero", fecha:"2025-02-20", contenido:"El segundo grado nos introduce en el estudio de las ciencias liberales y la búsqueda activa del conocimiento. El Compañero ya ha desbastado la piedra bruta y comienza a pulirla." },
...
function GenerarTenidasMasivo({ tenidas, setTenidas, msg }) {
  const T = useT();
  const [mostrar, setMostrar] = useState(false);
  const [semanas, setSemanas] = useState([2,4]);  // 2=segundo, 4=cuarto viernes (régimen oficial de la Logia)
